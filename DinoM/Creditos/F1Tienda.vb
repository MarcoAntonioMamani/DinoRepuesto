...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        If res Then
            ...
            ToastNotification.Show(Me, "Código de Tienda ".ToUpper + tbCodigoOriginal.Text + " Grabado con Exito.".ToUpper,
                                      img, 2000,
        ...
        Else
            ...
            ToastNotification.Show(Me, "El Tienda no pudo ser insertado".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.BottomCenter)
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If res Then
            ...
            Dim img As Bitmap = New Bitmap(My.Resources.checked, 50, 50)
            ToastNotification.Show(Me, "Código de Tienda ".ToUpper + tbCodigoOriginal.Text + " modificado con Exito.".ToUpper,
                                      img, 2000,
                                      eToastGlowColor.Green,
                                      eToastPosition.TopCenter)
            _PMInhabilitar()
        ...
        Else
            Dim img As Bitmap = New Bitmap(My.Resources.cancel, 50, 50)
            ToastNotification.Show(Me, "EL Tienda no pudo ser modificado".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.BottomCenter)
    ...
    Public Overrides Sub _PMOEliminarRegistro()
        ...
        If (bandera = True) Then
            ...
            If res Then
                ...
                ToastNotification.Show(Me, "Código de Tienda ".ToUpper + tbCodigoOriginal.Text + " eliminado con Exito.".ToUpper,
                                          img, 2000,
                                          eToastGlowColor.Green,
                                          eToastPosition.TopCenter)
    ...
    Public Overrides Function _PMOValidarCampos() As Boolean
        ...
        If tbNombre.Text = String.Empty Then
            ...
            MEP.SetError(tbNombre, "ingrese el nombre de la Tienda!".ToUpper)
            _ok = False
        Else
            tbNombre.BackColor = Color.White
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("ydcod", True, "Cod Tienda.".ToUpper, 100))
